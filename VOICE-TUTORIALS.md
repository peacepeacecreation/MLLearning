...
2. **Учень скаже "далі" / "наступне" / "готово, наступне"** — виведи наступне за поточним питання з flow.
...
Триггер `«готово»` завжди нагадувати, бо це те що активує flush LLM-черги.
