...
**Поточна фаза:** Фаза 0 ✅ **completed** → Фаза 1 (математика) **на паузі, 5/8 уроків** → **Фаза 2 наступна**
...
**На старті наступної сесії — швидкий retrieval Фази 1 (не пропускати):**
- Cosine similarity — написати без підказки
- Некомутативність матриць — пояснити словами (не тільки код)
- Chain rule на новому прикладі — з проговоренням, уважно на sign errors
- **Нормалізація features "чому прискорює GD"** — залишилось відкритим питанням, студент сказав "не знаю"
