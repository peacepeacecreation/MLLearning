...
**Рішення від 2026-07-19:** `lessons/phase-2/` розгорнуто в 9 уроків + capstone (README + методика). Урок 01 (sklearn fundamentals) і Урок 02 (лінійна регресія sklearn, closed-form vs GD, R², multicollinearity) — пройдено. Наступний крок — **Урок 03 (логістична регресія, класифікація)**.
